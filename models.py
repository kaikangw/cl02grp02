...
class User(db.Model):
    ...
    messages_sent = db.relationship('Messages', foreign_keys='Message.sender_id', backref='author', lazy='dynamic')
    messages_received = db.relationship('Messages', foreign_keys='Message.recipient_id', backref='recipient', lazy='dynamic')
